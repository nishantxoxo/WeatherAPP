...
fun WeatherCard(
    ...
    state.weatherInfo?.currentWeatherData?.let {
        data->  Card(backgroundColor = backgroundColor,
        ...
        Column(modifier = Modifier
            ...
            Row(modifier = Modifier.fillMaxWidth(),
                ...
                WeatherDataDisplay(value = data.windSpeed.roundToInt(), unit = "km/h", icon = ImageVector.vectorResource(id = R.drawable.ic_wind),
                    icontint = Color.White, textStyle = TextStyle(color = Color.White)
